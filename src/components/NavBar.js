  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap gap-x-3">
          <motion.a
            href="https://github.com/akbarsupia"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
          ...
          <motion.a
            href="https://www.linkedin.com/in/akbar-supia-dirja-7071192ba"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
          ...
          <motion.a
            href="https://www.instagram.com/akbarsdrjaa_"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
          ...
          <motion.a
            href="https://www.tiktok.com/@akbarr_sdrja"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
      ...
      {isOpen ? (
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap gap-x-3 mt-2">
            <motion.a
              href="https://github.com/akbarsupia"
              target={"_blank"}
              whileHover={{ y: -2 }}
