  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
        ...
        <Skill name="Looker Studio" x="0vw" y="-12vw" />
        <Skill name="Analisis Data" x="-22vw" y="-2vw" />
        <Skill name="Visualisasi Data" x="22vw" y="-2vw" />
        <Skill name="React.js" x="-15vw" y="12vw" />
        <Skill name="Node.js" x="15vw" y="12vw" />
        <Skill name="Firebase" x="0vw" y="20vw" />
        <Skill name="Firestore" x="-18vw" y="-12vw" />
        <Skill name="Cloud Functions" x="18vw" y="-12vw" />
        <Skill name="Canva" x="-30vw" y="6vw" />
        <Skill name="Microsoft Office" x="30vw" y="6vw" />
        <Skill name="Komunikasi & Presentasi" x="-25vw" y="-18vw" />
        <Skill name="Koordinasi Proyek" x="25vw" y="-18vw" />
      </div>
    </>
  );
};
