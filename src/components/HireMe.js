...
const HireMe = () => {
  // Trigger update for rotating text
  return (
    <div className="fixed left-4 bottom-4 z-30 flex items-center justify-center overflow-hidden md:right-4 md:left-auto md:bottom-4 md:top-auto">
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        <CircularText
          className={"fill-dark animate-spin-slow dark:fill-light"}
        />
        <Link
          href="https://wa.me/6281386176205"
          target={"_blank"}
          rel="noreferrer"
