          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                summary="Pengembangan website profil resmi untuk Yayasan Pendidikan Non-Formal PKBM Jaya Giri. Berfungsi sebagai pusat informasi pendaftaran peserta didik baru, galeri kegiatan pembelajaran, serta publikasi program pendidikan guna meningkatkan aksesibilitas pendidikan masyarakat."
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                summary="Dashboard visualisasi data logistik dan pemeliharaan armada transportasi terpadu. Menemukan inefisiensi biaya operasional bengkel hingga 15% melalui analisis pemakaian bahan bakar secara komparatif serta tracking inventaris sparepart."
            ...
            <div className="col-span-12">
              <FeaturedProject
                title="Corporate Looker Studio Training & HR Dashboard @ Perusahaan Ritel Elektronik Nasional"
                img={project6}
                carouselImages={[
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                summary="Dashboard analisis performa transaksi ritel komprehensif berbasis Looker Studio. Menyajikan visualisasi pertumbuhan pendapatan, tren penjualan harian/bulanan, efektivitas promosi, serta segmentasi metode pembayaran untuk membantu pengambilan keputusan bisnis retail secara real-time."
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                summary="Membantu UMKM Distrinesia dalam merumuskan keputusan pemasaran strategis berbasis data penjualan historis. Dashboard interaktif ini memvisualisasikan profit margin, tren penjualan musiman, dan segmentasi pasar untuk meningkatkan laba bersih perusahaan."
                link=""
                github=""
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                summary="Aplikasi web e-commerce premium untuk brand RS Parfume yang dilengkapi dengan katalog produk interaktif, sistem manajemen keranjang belanja, pemesanan langsung, serta integrasi sistem pembayaran digital yang aman dan seamless."
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                summary="Sistem dashboard tata kelola terintegrasi untuk Instansi Pemerintah mencakup modul Kepegawaian, Persuratan, Inventaris, Monitoring Kegiatan, dan kepatuhan Reformasi Birokrasi (LHKPN), meningkatkan transparansi administrasi sekolah hingga 40%."
